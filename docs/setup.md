...
3. **测试上传**：认证成功后尝试上传图片
4. **检查健康状态**：访问 `/status.html` 查看 API 健康状态，确保所有检查项显示"正常"

## API 健康状态监控

项目内置了 API 健康状态监控功能，帮助您实时了解系统运行状态。

### 访问方式

- **详细状态页面**: 访问 `/status.html` 查看完整的健康状态信息
- **快速状态指示**: 首页导航栏中的心跳图标显示当前状态

### 状态说明

- **绿色 ✓**: 所有 API 正常
- **橙色 ⚠️**: 部分 API 异常，但核心功能可用
- **红色 ✗**: API 异常，需要检查
- **灰色 ?**: 状态未知
